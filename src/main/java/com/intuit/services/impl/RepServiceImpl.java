...
public class RepServiceImpl implements RepService {
    ...
    @Override
    public String createEntry(Rep rep) throws PersistentException {
        return repDao.save(rep);
    }

    @Override
    public RepAssignCallResponse assignCall(String repId, TimeSlotInTimestamp timeSlot) throws NoSuchElementException, ValidationException, PersistentException {
    ...
    @Override
    public void completeCall(String repId, String callbackId) throws ValidationException, PersistentException {
